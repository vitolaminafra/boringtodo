...
export class TopBarComponent {
  ...
  loadSampleData() {
    this.confirmationService.confirm({
      message: 'Are you sure you want to load sample data? All current tasks will be deleted.',
      ...
      accept: () => {
        ...
        this.messageService.add({ severity: 'success', summary: 'Loaded', detail: 'Loaded sample data.' });
      },
    });
  }
  ...
  deleteAll() {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.messageService.add({ severity: 'success', summary: 'Deleted', detail: 'All tasks have been deleted.' });
      },
    });
  }
